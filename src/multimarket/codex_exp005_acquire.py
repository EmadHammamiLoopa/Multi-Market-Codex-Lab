...
def download_one(
    ...
    *,
    ...
    try:
        ...
        # Preserve failed bytes for forensic review. Never retry or overwrite silently.
        raise
...
def run(
    ...
    # Printed before any HTTP client is created, as required by the preregistration.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Frozen post-review acquisition for CODEX-EXP-005-P0."
    )
