...
EXP012_RESULT = Path("evidence/codex/exp012_p0_segmented_options_flow/SEGMENTED_OPTIONS_FLOW_P0_AUDIT.json")
EXP012_RESULT_SHA256 = "c30329af81c84a4dc1973c32fcf06a544fb91340aaadedf6ca810d29f18735fe"
OUT = Path("evidence/codex/exp013_p0_corrected_expiry_segmented_options_flow/CORRECTED_EXPIRY_SEGMENTED_OPTIONS_FLOW_P0_AUDIT.json")
...
def parse_symbol(symbol: str):
    ...
    expiry = datetime.strptime(expiry_text, "%d%b%y").replace(hour=8, minute=0, second=0, microsecond=0, tzinfo=timezone.utc)
...
def main(argv=None):
    ap = argparse.ArgumentParser(description="Frozen CODEX-EXP-013-P0 segmented BTC options-flow readiness audit")
    ...
    invariants = {
        "exp012_result_sha256_verified": True,
