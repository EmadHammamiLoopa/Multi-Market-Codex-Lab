...
| CODEX-EXP-003 | 2026-08-25 | Causal Binance Spot + Bybit information with a 500 ms receipt embargo can add executable 10--30 s edge beyond Binance-futures L2 | Frozen `e6109a78...` | X0/X1/X2/XALL; balanced logistic, Platt calibration; 10/30 s | BTCUSDT/ETHUSDT first-day Jan--Jul 2026; 56 frozen external files; sandbox only | 250 ms target reaction; 500 ms primary external embargo; 8 bp primary, 12 bp stress | **FAIL**: XALL 142 actions, -8.8544 bp/action @8 vs X0 -7.4492; 0/5 positive folds; future-leak canary strongly positive only | Preserve unchanged; stop 10--30 s microstructure escalation and move to model-free longer-horizon economic-headroom audit |
...
| CODEX-PROVENANCE-EXP003-001 | `e6109a78...` | Frozen 56-file acquisition plus full pre-score input audit | PASS: 56/56; 125,271,066 rows; 1,941,817,406 bytes; hashes matched; no August opened | `evidence/codex/exp003_acquisition_manifest.json`; `evidence/codex/exp003_input_audit.json` |
| CODEX-RUN-EXP003-PRIMARY-001 | `e6109a78...` | Frozen primary 500 ms causal cross-venue walk-forward | **FAIL**: X0 79 actions at -7.4492 bp/action @8; XALL 142 at -8.8544; XALL worse by -1.4052; 0/5 positive folds | `evidence/codex/exp003_result/PRIMARY_500MS.json`; `docs/CODEX_EXP003_RESULT.md` |
| CODEX-DIAG-EXP003-001 | `e6109a78...` | Frozen 250/1000 ms, timestamp permutation, sign placebo, 60 s time placebo, future-leak positive-control suite | Diagnostic-only; none may rescue primary; future canary 604 actions, +5.8508 bp/action @8, +1.8508 @12, 5/5 positive folds | `evidence/codex/exp003_result/`; `evidence/codex/exp003_result/CODEX_EXP003_DIAGNOSTIC_ADJUDICATION.json` |
