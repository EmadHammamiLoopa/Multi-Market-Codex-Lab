...
## 283. DEV042-P3 canonical predictive screen complete; no survivor; family closed

DEV042-P3 completed its single authorized canonical predictive/economic/null
screen.
...
All five candidates failed final eligibility and the joint temporal null.
...
Candidate economic summary:

### C0_PRICE_LOGIT

- mean gross = -0.8900524201131313 bps/trade
- C1 mean net = -10.890052420113133
- C2 mean net = -16.890052420113133
- C2 total = -2026.8062904135759
...
- C1 mean net = -11.732550243745715
- C2 mean net = -17.732550243745717
- C2 total = -2464.8244838806545
...
Strongest economic candidate in the family, but still failed.

- mean gross = +2.5357003777301026 bps/trade
- C1 mean net = -7.4642996222698965
- C1 total = -970.3589508950865
- C2 mean net = -13.464299622269898
- C2 total = -1750.3589508950868
- C2 PF = 0.3233688578333247
- positive folds = 0/4
- minimum fold C2 mean = -17.881529397618987
- minimum LOO C2 mean = -14.47573232051467
- joint q95 = -11.776452244869635
- FWER p = 0.274
- null PASS = false

This result is NOT eligible for threshold, cost, hyperparameter, or feature
rescue inside DEV042.

### C3_COMBINED_LOGIT

- mean gross = -0.10500292978610945
- C1 mean net = -10.105002929786108
- C2 mean net = -16.10500292978611
- C2 total = -2657.3254834147083
...
Best classification macro-F1 but economically failed.

- macro F1 = 0.3937571971448197
- mean gross = -0.34263341872951775
- C1 mean net = -10.342633418729516
- C2 mean net = -16.34263341872952
- C2 total = -3105.1003495586087
...
All five candidates failed the null gate.

Scientific interpretation:

DEV041 proved that H1800/B32 contains strong oracle executable headroom.

DEV042 proved that the frozen decision-time PRICE/OFI/PRESSURE-CAPACITY and
combined linear/nonlinear model family does NOT recover that headroom
predictively under executable economics.

The strongest gross candidate was PRESSURE_CAPACITY_LOGIT at only about
+2.54 bps/trade, far below even the lighter 10-bp C1 cost envelope and not
family-wise significant.

Therefore the core bottleneck remains predictive-economic alignment, not
oracle target geometry or trade activity.

Canonical result freeze:

`docs/DEV042_P3_CANONICAL_RESULT_FREEZE.md`

Result-freeze commit:

`6404363fff5a5ebb987ec6b8a52eea33916d96af`

The exact DEV042 H1800/B32 family is CLOSED.

Any future experiment must be a genuinely new preregistered scientific family,
not a DEV042 rescue.
